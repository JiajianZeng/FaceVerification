function [ pair1, pair2 ] = generate_data_pair( image_list_path, min_id, max_id, ratio, data_pair1_file, data_pair2_file, label_file )
...
fid1 = fopen(data_pair1_file, 'a');
fid2 = fopen(data_pair2_file, 'a');
fid3 = fopen(label_file, 'a');

for i = 1:length(pair1)
    fprintf(fid1, '%s %d\r\n', image_list{1}{pair1(i)}, image_list{2}(pair1(i)));
    fprintf(fid2, '%s %d\r\n', image_list{1}{pair2(i)}, image_list{2}(pair2(i)));
    fprintf(fid3, '%s %d\r\n', image_list{1}{pair1(1)}, labels(i));
end
