function [] = data_statistics( image_list_path, image_statistics_file )
...
image_statistics_file = fopen(image_statistics_file, 'w');
...
num_class = length(unique(image_list{2}));

disp(['In data statistics, ', 'total ', num2str(num_class), ' classes.']);
...
fprintf(image_statistics_file, '%s\r\n', ['In data statistics, ', 'total ', num2str(num_class), ' classes.']);
